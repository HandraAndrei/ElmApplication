...
personalDetails =
    { name = "Andrei Handra"
    , intro = "I like computers, music and football"
    , contacts = [ DetailWithName "email" "andreihandra@gmail.com" ]
    , socials = [ DetailWithName "github" "https://github.com/HandraAndrei" ]
    }
